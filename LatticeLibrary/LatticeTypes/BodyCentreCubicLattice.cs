    ...
    namespace LatticeLibrary
    {
	    public class BodyCentreCubicLattice : ILatticeType
        {
                ...
                uint            nSubSamples = 2)
            {
                ...
                {
                    throw new Exception("Body Centre Cubic Lattice only supports Unit Cells with 8 Corners.");
                }
                ...
                //beam connecting logic: edges
                AddBeam(ref oLattice, vecPt0, vecPt1, xBeamThickness, nSubSamples);
                AddBeam(ref oLattice, vecPt1, vecPt2, xBeamThickness, nSubSamples);
                AddBeam(ref oLattice, vecPt2, vecPt3, xBeamThickness, nSubSamples);
                AddBeam(ref oLattice, vecPt3, vecPt0, xBeamThickness, nSubSamples);

                AddBeam(ref oLattice, vecPt0, vecPt4, xBeamThickness, nSubSamples);
                AddBeam(ref oLattice, vecPt1, vecPt5, xBeamThickness, nSubSamples);
                AddBeam(ref oLattice, vecPt2, vecPt6, xBeamThickness, nSubSamples);
                AddBeam(ref oLattice, vecPt3, vecPt7, xBeamThickness, nSubSamples);

                AddBeam(ref oLattice, vecPt4, vecPt5, xBeamThickness, nSubSamples);
                AddBeam(ref oLattice, vecPt5, vecPt6, xBeamThickness, nSubSamples);
                AddBeam(ref oLattice, vecPt6, vecPt7, xBeamThickness, nSubSamples);
                AddBeam(ref oLattice, vecPt7, vecPt4, xBeamThickness, nSubSamples);
            }
